...
registerWhen(
  ...
  }).setChatCriteria("HOPPITY'S HUNT A Chocolate ${eggtype} Egg has appeared!"),
  () => settings.chocolatelocation,
  { type: 'chat', name: 'Chocolate Egg' }
);
...
registerWhen(
  register('chat', (eggtype) => {
    ...
    "HOPPITY'S HUNT You found a Chocolate ${eggtype} Egg ${location}!"
  ),
  () => settings.chocolatelocation,
  { type: 'chat', name: 'Chocolate Egg' }
);
...
registerWhen(
  ...
  () => settings.chocolatelocation,
  { type: 'renderWorld', name: 'Chocolate Egg' }
);
