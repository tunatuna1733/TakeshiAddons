...
registerWhen(register('renderWorld', () => {
    if (isInGoldor && isInM7) {
        if (currentClass === 'Tank') {
            renderBeaconBeam(TerminalCoords.First[0].x, TerminalCoords.First[0].y, TerminalCoords.First[0].z, settings.terminalcolor.getRed() / 255, settings.terminalcolor.getGreen() / 255, settings.terminalcolor.getBlue() / 255, settings.terminalcolor.getAlpha() / 255, true);
            renderBeaconBeam(TerminalCoords.Second[0].x, TerminalCoords.Second[0].y, TerminalCoords.Second[0].z, settings.terminalcolor.getRed() / 255, settings.terminalcolor.getGreen() / 255, settings.terminalcolor.getBlue() / 255, settings.terminalcolor.getAlpha() / 255, true);
            renderBeaconBeam(TerminalCoords.Third[0].x, TerminalCoords.Third[0].y, TerminalCoords.Third[0].z, settings.terminalcolor.getRed() / 255, settings.terminalcolor.getGreen() / 255, settings.terminalcolor.getBlue() / 255, settings.terminalcolor.getAlpha() / 255, true);
            renderBeaconBeam(TerminalCoords.Forth[0].x, TerminalCoords.Forth[0].y, TerminalCoords.Forth[0].z, settings.terminalcolor.getRed() / 255, settings.terminalcolor.getGreen() / 255, settings.terminalcolor.getBlue() / 255, settings.terminalcolor.getAlpha() / 255, true);
        }
